...
executor_llm = ChatOllama(model="qwen2.5:14b", temperature=0.0, response_format="json")
...
if __name__ == "__main__":
    ...
    prompt_io = "How many io ports does product 4 have?"
    print(you+prompt_io)
    response = agent.run(prompt_io)
    print("LLM:", response)

    prompt_update = "Update the number of IO ports of product 4 to 8."
    print(you+prompt_update)
    response = agent.run(prompt_update)
    print("LLM:", response)
